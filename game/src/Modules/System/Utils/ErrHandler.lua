function love.errorhandler(msg)
    ...
    local fontcache = require 'src.Modules.System.Utils.FontCache'
    ...
    -- assets --
    local errorGradient = love.graphics.newGradient("vertical", {104 / 255, 184 / 255, 97 / 255, 1}, {48 / 255, 93 / 255, 44 / 255, 1})
    ...
    love.graphics.reset()
    local font = fontcache.getFont("comfortaa_regular", 16)
    ...
    local function draw()
        ...
        love.graphics.printf(p, font, pos, pos + 2, love.graphics.getWidth() - pos)
